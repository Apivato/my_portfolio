    ...
    render (){
        return (
            <div className='wrapper'>
                <Navbar/>
                <div className='body text-[#81CFE0] text-base sm: md: lg: xl: 2xl: py-10 pl-48'>
                    <div className='header font-bold'>
                        <h1>Hi, my name is Amos Anthony Pivato</h1>
                        <hr className="my-8 mx-16 border-2 border-[#81CFE0]"></hr>
                    </div>
                    <div className='content my-32 flex justify-center items-center'>
